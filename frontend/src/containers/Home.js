		...
		<div className='row mt-5 mb-5'>
			...
			<div className='offset-2 col-7'>
				<ul className='list-group list-group-flush mt-5'>
					<li className='list-group-item fs-4 lead'>Insane Comfort</li>
					<li className='list-group-item fs-4 lead'>Greatest Sound Quality</li>
					<li className='list-group-item fs-4 lead'>Bluetooth Compatible</li>
					<li className='list-group-item fs-4 lead'>Size Adjustable</li>
					<li className='list-group-item fs-4 lead'>Noise Cancelling</li>
					<li className='list-group-item fs-4 lead'>Built-In Microphone</li>
				</ul>
			</div>
		</div>
	</Layout>
